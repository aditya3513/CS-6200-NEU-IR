...
visited_link_file = open("visited_link_file_q1_carbon_footprint.txt","w+")
...
def getChildLinks(parent):
	...
	file_name = "html_files_q1_carbon_footprint/" + file_name + ".txt"
...
print("all links added to file: visited_link_file_q1_carbon_footprint.txt in this folder")
