...
#given input to us
origin = "https://en.wikipedia.org/wiki/Time_zone"
max_depth = 6
max_links = 1000
start = 0
base_url = "https://en.wikipedia.org"

visited_link_file = open("visited_link_file_q1_time_zone.txt","w+")
...
def getChildLinks(parent):
	...
	file_name = "html_files_q1_time_zone/" + file_name + ".txt"
...
print("all links added to file: visited_link_file_q1_time_zone.txt in this folder")
